function varargout = SMRTool_v207_win_temp(varargin)
...
%    SMRTool_v207_win_temp, Copyright (C) 2015 Adrián Riquelme Guill
%    SMRTool_v207_win_temp comes with ABSOLUTELY NO WARRANTY.
%    This is free software, and you are welcome to redistribute it
%    under certain conditions.
% SMRTOOL_V207_WIN_TEMP MATLAB code for SMRTool_v207_win_temp.fig
%      SMRTOOL_V207_WIN_TEMP, by itself, creates a new SMRTOOL_V207_WIN_TEMP or raises the existing
%      singleton*.
%
%      H = SMRTOOL_V207_WIN_TEMP returns the handle to a new SMRTOOL_V207_WIN_TEMP or the handle to
%      the existing singleton*.
%
%      SMRTOOL_V207_WIN_TEMP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SMRTOOL_V207_WIN_TEMP.M with the given input arguments.
%
%      SMRTOOL_V207_WIN_TEMP('Property','Value',...) creates a new SMRTOOL_V207_WIN_TEMP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SMRTool_v207_win_temp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SMRTool_v207_win_temp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SMRTool_v207_win_temp

% Last Modified by GUIDE v2.5 23-Mar-2019 19:03:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SMRTool_v207_win_temp_OpeningFcn, ...
                   'gui_OutputFcn',  @SMRTool_v207_win_temp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SMRTool_v207_win_temp is made visible.
function SMRTool_v207_win_temp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SMRTool_v207_win_temp (see VARARGIN)

% Choose default command line output for SMRTool_v207_win_temp
...
% UIWAIT makes SMRTool_v207_win_temp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SMRTool_v207_win_temp_OutputFcn(hObject, eventdata, handles) 
